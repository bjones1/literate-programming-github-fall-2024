...
// <p><strong>The goal of the program here is to allow at the end of each iteration, that thor approaches the light using its coordinates</strong></p>
// <p><img src="pseudocode.jpg" alt="pre writting"></p><p>ROA: This is a good resume of the problem. I would suggest drawing a two dimensional graph to get a better image of how Thor should move.</p>
// <h3>Pseudocode</h3>
...
/* <p>ROA: The variable names are clear and descriptive, and the input is correctly parsed.&nbsp;</p> */
   ...
   while (1) 
    {
        ...
        // <p>A single line providing the move to be made: N NE E SE S SW W or NW</p>
