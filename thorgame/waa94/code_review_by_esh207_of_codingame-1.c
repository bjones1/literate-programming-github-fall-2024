...
// **ESH: This is a good summary of the problem and the methods used to find the solution. There could be a few commas placed to break up some of the longer sentances.**
...
int main()
{
   ...
   while (1) 
    ...
    // **ESH:The code itself is very readable, both in Code Chat and an IDE, with sensible variable names. Some of the comments are poorly placed in my opinion, such as the coordinate variable declaration.**
